    ...
    <div className="min-h-screen">
      ...
      <section className="container mx-auto py-20 text-center">
        <h1 className="text-4xl sm:text-5xl md:text-7xl
         lg:text-8xl font-extrabold gradient-title pb-6 flex flex-col">
          Streamline Your Workflow <br />
          <span className="flex -mt-2 mx-auto gap-3 sm:gap-3 items-center md:-mt-8">
            with
            <Image
              src={"/logo.png"}
              alt="Zscrum Logo"
              width={400}
              height={90}
              className="h-14 -ml-2 md:h-32 md:pt-4 sm:h-24 w-auto object-contain lg:h-40"
            />
          </span>
        </h1>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="bg-opacity-30 backdrop-blur-md border border-gray-600 border-opacity-20 rounded-lg p-4">
